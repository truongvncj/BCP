...
namespace BCP
{
    ...
    public class ExcelProvider
    {
        ...
        public DataTable GetDataFromExcel(string filename)
        {
            ...
            theWorkbook = xlApp.Workbooks.Open(strPath);
        ...
        public static DataTable oldexampleGetDataFromExcel2(string filePath)
        {
        ...
        public static DataTable odlexampleGetDataFromExcel3(string fileName)
        {
