...
//BCP.LinqtoSQLDataContext

namespace BCP.Control
{
    //  D:\GitHub\Arconfirmationletter\arconfirmationletter\Control\ExportToExcel.cs

    class Control_ac
    {
        //       public static object ExportToExcel { get; private set; }
        ...
        public static void exportsexcelOld(object objextoEl)
        {
            ...
            excelSheet.get_Range(excelRange, Type.Missing).Cells.NumberFormat = "@";  // kiểu text


            excelSheet.get_Range(excelRange, Type.Missing).Value2 = rawData;  // gán giá trị
        ...
        public void exportExceldatagridtofile(IQueryable IQuery, LinqtoSQLDataContext db, string tittle)
        {
            ...
            if (theDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Thread t1 = new Thread(exportsexcelOld);
        ...
        public void exportdatagriddatatabletofile(DataTable datatable1, string tittle)
        {
