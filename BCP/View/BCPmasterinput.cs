...
namespace BCP.View
{
    public partial class BCPmasterinput : Form
    {
        public BCPmasterinput()
        {
            InitializeComponent();
        ...
        {
            Control.PriceCheck.PriceRawUpload inputproduct = new Control.PriceCheck.PriceRawUpload();


            inputproduct.inputProductlist();
        ...
        {
            Control.PriceCheck.PriceRawUpload upload = new Control.PriceCheck.PriceRawUpload();
            upload.inputpromotionpricelist(1); //' 1 là promotion' 2 là function , 3 là surcharge
        ...
        {
            Control.PriceCheck.PriceRawUpload upload = new Control.PriceCheck.PriceRawUpload();
            upload.inputpromotionpricelist(2); //' 1 là promotion' 2 là function , 3 là surcharge
