...
namespace BCP.View
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
           ...
           InitializeComponent();
            lbusername.Text = Utils.getUsername();
    ...
    //    }
     ...
     //   }
        ...
        {
            View.BCPPasswordchange changep = new BCPPasswordchange();
            changep.ShowDialog();
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            OleDbDataAdapter adapter =
             new OleDbDataAdapter("SELECT * FROM tbl_Temp", conn);
            adapter.Fill(ds);
            conn.Close();
        ...
        private void pictureBox3_MouseHover(object sender, EventArgs e)
        {
            ...
            this.inputusser.BorderStyle = BorderStyle.Fixed3D;
        ...
        {
            this.inputusser.BorderStyle = BorderStyle.None;
        }

        private void pictureBox1_MouseHover(object sender, EventArgs e)
        {
       //    this.pic_arrelease.Image = global::BCP.Properties.Resources.input21;
          
        }

        private void pictureBox1_MouseLeave(object sender, EventArgs e)
        {
    //     this.pic_arrelease.Image = global::BCP.Properties.Resources.input1;
        }

        private void pictureBox4_MouseHover(object sender, EventArgs e)
        {
   //       this.pic_printinvoice.Image = global::BCP.Properties.Resources.payment2;
         //   webBrowser1.Refresh();
        }

        private void pictureBox4_MouseLeave(object sender, EventArgs e)
        {
        // this.pic_printinvoice.Image = global::BCP.Properties.Resources.payment1;
        }

        private void pictureBox6_MouseHover(object sender, EventArgs e)
        {
        this.inputmarterdata.Image = global::BCP.Properties.Resources.master2;
        ...
        {
      //    this.pic_ordercreate.Image = global::BCP.Properties.Resources.saleupdate2;
        }

        private void pictureBox2_MouseLeave(object sender, EventArgs e)
        {
        //  this.pic_ordercreate.Image = global::BCP.Properties.Resources.saleupdate1;
        }

        private void pictureBox5_MouseHover(object sender, EventArgs e)
        {
        //  this.pic_shipmentcreate.Image = global::BCP.Properties.Resources.Reports2;
        }

        private void pictureBox5_MouseLeave(object sender, EventArgs e)
        {
        //  this.pic_shipmentcreate.Image = global::BCP.Properties.Resources.Reports1;
        }
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            if (!kq)
            {
                ...
                View.BCPmasterinput BCPmasterinput = new View.BCPmasterinput();


                BCPmasterinput.ShowDialog();
            }
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
           ...
           View.BCPreportsform kareportsform = new View.BCPreportsform();
        ...
        private void pic_ordercreate_MouseHover(object sender, EventArgs e)
        {
            this.pic_ordercreate.BorderStyle = BorderStyle.Fixed3D;

        }

        private void pic_ordercreate_MouseLeave(object sender, EventArgs e)
        {
            this.pic_ordercreate.BorderStyle = BorderStyle.None;

        }

        private void pic_arrelease_MouseHover(object sender, EventArgs e)
        {
            this.pic_arrelease.BorderStyle = BorderStyle.Fixed3D;
        }

        private void pic_arrelease_MouseLeave(object sender, EventArgs e)
        {
            this.pic_arrelease.BorderStyle = BorderStyle.None;
        }

        private void pic_shipmentcreate_MouseHover(object sender, EventArgs e)
        {
            this.pic_shipmentcreate.BorderStyle = BorderStyle.Fixed3D;

        }

        private void pic_shipmentcreate_MouseLeave(object sender, EventArgs e)
        {
            this.pic_shipmentcreate.BorderStyle = BorderStyle.None;
        }

        private void pic_printinvoice_MouseHover(object sender, EventArgs e)
        {
            this.pic_printinvoice.BorderStyle = BorderStyle.Fixed3D;
        }

        private void pic_printinvoice_MouseLeave(object sender, EventArgs e)
        {
            this.pic_printinvoice.BorderStyle = BorderStyle.None;
        }

     

        private void pic_report_MouseHover(object sender, EventArgs e)
        {
            this.pic_report.BorderStyle = BorderStyle.Fixed3D;
        }

        private void pic_report_MouseLeave(object sender, EventArgs e)
        {
            this.pic_report.BorderStyle = BorderStyle.None;
        ...
        private void pic_ordercreate_Click(object sender, EventArgs e)
        {
            ...
            if (!kq)
            {
                ...
                View.BCPOrderEntry BCPOrderEntry = new View.BCPOrderEntry("Order Entry","0");


                BCPOrderEntry.ShowDialog();
            }
        }
        ...
        private void pic_arrelease_Click(object sender, EventArgs e)
        {
            ...
            if (!kq)
            {
                ...
                View.BCPArrelease BCPArrelease = new View.BCPArrelease();


                BCPArrelease.ShowDialog();
            }
        }
        ...
        private void pic_shipmentcreate_Click(object sender, EventArgs e)
        {
            ...
            if (!kq)
            {
                ...
                View.BCPShipmentCreate BCPShipmentCreate = new View.BCPShipmentCreate();


                BCPShipmentCreate.ShowDialog();
            }
        }
        ...
        private void pic_printinvoice_Click(object sender, EventArgs e)
        {
            ...
            if (!kq)
            {
                ...
                View.BCPPrintIvoiceLoad BCPPrintIvoiceLoad = new View.BCPPrintIvoiceLoad();
