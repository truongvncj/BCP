...
namespace BCP.View
{
    ...
    public partial class CreatenewContract : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            //string ctrnocheck =       this.tb_contractno.Text.Trim();

            //string ctrtypecheck =    this.cb_contracttype.SelectedItem.ToString();

            //string ctrchanelcheck =   (cb_channel.SelectedItem as ComboboxItem).Value.ToString();


            //      if (ctrtypecheck =="RKA" && ctrnocheck.PadLeft(5) != "S/KA/")
            //      {
            //          MessageBox.Show("Contract type: RKA so contract no must be: S/KA/.... ", "Thông báo ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //          return;
            //      }


            //      if (ctrtypecheck == "NKA" && ctrnocheck.PadLeft(5) != "S/KA/")
            //      {
            //          MessageBox.Show("Contract type: RKA so contract no must be: S/KA/.... ", "Thông báo ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //          return;
            //      }
            ...
            for (int idrow = 0; idrow < dataGridProgramdetail.RowCount - 1; idrow++)
            {
                ...
                ////---
                //if (dataGridProgramdetail.Rows[idrow].Cells["Effect_From"].Value != null && dataGridProgramdetail.Rows[idrow].Cells["Payment_Control"].Value.ToString() == "C01")
                //{
                ...
                ////--
                //if (dataGridProgramdetail.Rows[idrow].Cells["Effect_To"].Value != null && dataGridProgramdetail.Rows[idrow].Cells["Payment_Control"].Value.ToString() == "C01")
                //{
        ...
        private void bt_etcontract_Click(object sender, EventArgs e)
        {
            ...
            View.BCPDatepick exdate = new BCPDatepick("Choose Ext Date");
            exdate.ShowDialog();


            DateTime olđate = dateTimePicker3.Value;
            DateTime extdate = exdate.valueDate;
            bool chon1 = exdate.kq;
        ...
        {
            View.BCPvalueinput inputval = new BCPvalueinput("Input some text in Name to seach code", "");
        ...
        {
            View.BCPvalueinput inputval = new BCPvalueinput("Input some text in Name to seach SFA code", "");
        ...
        {
            View.BCPvalueinput inputval = new BCPvalueinput("Input some text in Name to seach Group code", "");
        ...
        private void btchangeRemark_Click(object sender, EventArgs e)
        {
            ...
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new remarks to change", txt_remarkstt.Text);
        ...
        private void btrepresent_Click(object sender, EventArgs e)
        {
            ...
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new Representation to change", "");
            valueiput.ShowDialog();
        ...
        {
            //
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new Name to change", "");
            valueiput.ShowDialog();
        ...
        {
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new Home no to change", "");
            valueiput.ShowDialog();
        ...
        private void btchangedistric_Click(object sender, EventArgs e)
        {
            ...
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new District to change", "");
            valueiput.ShowDialog();
        ...
        {
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new Province to change", "");
            valueiput.ShowDialog();
        ...
        {
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new VAT no to change", "");
            valueiput.ShowDialog();
        ...
        private void button1_Click_5(object sender, EventArgs e)
        {
            ...
            View.BCPDatepick exdate = new BCPDatepick("Choose Eff to date");
            exdate.ShowDialog();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            View.BCPDatepick exdate = new BCPDatepick("Choose Eff From date");
            exdate.ShowDialog();
        ...
        {
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input new Credit Limit to change", "");
            valueiput.ShowDialog();
        ...
        {
            View.BCPvalueinput valueiput = new BCPvalueinput("Please input Contract no to change", "");
            valueiput.ShowDialog();
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            List<BCPselectinput.ComboboxItem> CombomCollection = new List<BCPselectinput.ComboboxItem>();
            ...
            {
                BCPselectinput.ComboboxItem cb = new BCPselectinput.ComboboxItem();
                cb.Value = item2.Contractype.Trim();
                cb.Text = item2.Contractype.Trim();//  + ": " + item2.Description.Trim() + "    || Example: " + item2.Example;
                CombomCollection.Add(cb);
            }

            View.BCPselectinput valueiput = new BCPselectinput("Please input new contract type to change", CombomCollection);
            valueiput.ShowDialog();
        ...
        private void button1_Click_7(object sender, EventArgs e)
        {
            ...
            View.BCPselectinput valueiput = new BCPselectinput("Please input new Region to change", CombomCollection);
            valueiput.ShowDialog();
        ...
        private void btAddGroupcode_Click(object sender, EventArgs e)
        {
            ...
            //View.BCPSeachaddcode inputval = new BCPSeachaddcode(contractNo);// ("Input some text in Name to seach code", "");
